...
const spider = (chart, config, setResponseFilter) => {
  config.width = parseInt(getComputedStyle(chart).width);
  chart.innerHTML = "";
  chart.update = (update) => {
    if (!update) return spider(chart, config, setResponseFilter);
    // apply update;
  };
  ...
  var d = [
    [
      { axis: "Caring", value: 7.2 },
      { axis: "Trust", value: 5 },
      { axis: "Understanding", value: 6 },
      { axis: "Connected", value: 6 },
      { axis: "Open & Honest", value: 8 },
      { axis: "Customer Experience", value: 4 },
      { axis: "Diversity & Inclusion", value: 6 },
      { axis: "Environment & Sustainability", value: 6 }
    ]
  ];
